...
var connectionString = builder.Configuration.GetConnectionString("RealAsmContextConnection");;

builder.Services.AddDbContext<RealAsmContext>(options =>
    options.UseSqlServer(connectionString));;

builder.Services.AddDefaultIdentity<RealAsmUser>(options => options.SignIn.RequireConfirmedAccount = true)
    .AddRoles<IdentityRole>()
    .AddEntityFrameworkStores<RealAsmContext>();;
